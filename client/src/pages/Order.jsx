...
//   return (
//     <div style={{ display: 'flex', alignItems: 'center', marginTop: 20, marginBottom: 4 }}>
//       {TRACK_STEPS.map((step, i) => {
//         const reached = i <= currentIndex;
//         return (
//           <div key={step} style={{ display: 'flex', alignItems: 'center', flex: i === TRACK_STEPS.length - 1 ? 'none' : 1 }}>
...
//                   flex: 1,
//                   height: 2,
//                   background: i < currentIndex ? C.gold : C.line,
//                   marginBottom: 16,
...
const OrderTracker = ({ status }) => {
  ...
  return (
    <div style={{ position: 'relative', marginTop: 24, marginBottom: 4, padding: '0 6px' }}>
      {/* base line (always visible, spans full width) */}
      <div
        style={{
          position: 'absolute',
          top: 6,
      ...
      />
      {/* gold progress line, width driven by current status */}
      <div
        style={{
          position: 'absolute',
          top: 6,
