...
import { LayoutDashboard, Package, ShoppingCart, Tag, XCircle, RotateCcw, Repeat, LogOut } from 'lucide-react';
...
const links = [
  ...
  { to: '/admin/return-requests', label: 'Return Requests', icon: RotateCcw },
  { to: '/admin/exchange-requests', label: 'Exchange Requests', icon: Repeat },
